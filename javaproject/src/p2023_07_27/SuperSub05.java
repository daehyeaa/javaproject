...
// 자식 클래스로 객체를 생성한 다음에 메소드를 호출하면, 메소드 오버라이딩된 메소드만 호출한다.
// 부모클래스의 상속 해주는 메소드는 더 이상 사용 할 수 없는 은닉메소드가 된다.
// 부모클래스의 은닉 메소드를 사용하기 위해서는 자식클래스에서 super.parentPrn() 형식으로 호출해서 사용 할 수 있다.
...
class Child05 extends Parent05 {
	...
	public void parentPrn() {
		...
		System.out.println("서브 클래스11 : ParentPrn 메서드");
	}

	public void childPrn() {
		super.parentPrn();	// 부모클래스의 은닉 메소드 호출
		System.out.println("서브 클래스22 : ChildPrn 메서드");
	}
}
