...
public class FileOutputStreamTest {
	public static void main(String[] args) {
		...
		try {
			...
			// FileOutputStream fos = new FileOutputStream("read1.txt"); // 상대경로
			// FileOutputStream fos = new FileOutputStream("d:/read1.txt"); // 절대경로
			fos = new FileOutputStream("d:/read1.txt"); // 절대경로
